...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $users = "SELECT id FROM users WHERE email=?";
    $bit = $conn->prepare($users);
    ...
    if ($bit->num_rows > 0) {
        ...
        $users = "INSERT INTO users (adi, soyadi, email, numara, sifre, il, ilce) VALUES (?, ?, ?, ?, ?, ?, ?)";
        $bit = $conn->prepare($users);
        $bit->bind_param('sssssss', $adi, $soyadi, $email, $numara, $sifre, $il, $ilce);
...
<body>
    <div class="container">
        <div class="left">
            ...
            <img src="resimler/Müşteri Kaydı.png" alt="">
            <h1>Müşteri Kaydı</h1>
            <p>Hizmetlere kolayca ulaşmak için hemen kaydol!</p>
        </div>
        <div class="right">
            <form action="users.php" method="post">
                ...
                <div class="input-row">
                    ...
                    <select id="iller" name="il" onchange="updateDistricts()" required>
                ...
                <div class="button-container">
                    <button type="submit" id="submitBtn" class="login-btn"><img src="resimler/Müşteri Kaydı.png" alt=""> <strong>Kayıt Ol</strong></button>
